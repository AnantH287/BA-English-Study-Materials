...
import img1 from './images/williamblake-1.jpeg';
import img2 from './images/williamblake-2.jpeg';
import img3 from './images/williamblake-3.jpeg';
import img4 from './images/williamblake-4.jpeg';
 ...
 const Cacophony = () => {
  ...
  const Navigate_page=()=>{
    if(username){
      navigate('/Cacophony_test')
    } else {
      alert('Student Please Login')
    }
  }
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:3000/literature/11')
      .then((response) => {
...
const handleBookMark=(e)=>{
  ...
  console.log('Bookmark button clicked');
    if(username){
      ...
      alert("Dear Student Please Login") 
    }
}
  return (
    <div>
