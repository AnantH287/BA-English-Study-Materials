...
import img1 from './images/four-1.jpeg';
import img2 from './images/four-2.jpeg';
import img3 from './images/four-3.jpeg';
import img4 from './images/four-4.jpeg';
 ...
 const Diligent = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:3000/literature/12')
      .then((response) => {
