...
import img1 from './images/jhonmilton-1.jpeg';
import img2 from './images/jhonmilton-2.jpeg';
import img3 from './images/jhonmilton-3.jpeg';
import img4 from './images/jhonmilton-4.jpeg';
 ...
 const Benevolent = () => {
  ...
  const Navigate_page=()=>{
    if(username){
      navigate('/Benevolent_test')
    } else {
      alert('Student Kindly Login')
    }
  }
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:3000/literature/10')
      .then((response) => {
